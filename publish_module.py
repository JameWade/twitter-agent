...
class PublishModule:
    ...
    def record_published_tweet(self, tweet_url: str, content: str, record_file: str = 'posted_tweets.txt'):
        """记录已发布的推文"""
        try:
            # 只保存到tuiwen.txt
    ...
    def get_tweet_statistics(self, content: str) -> dict:
        ...
        return {
            ...
            'urls': len([word for word in content.split() if word.startswith(('http://', 'https://'))]),
